...
HD_PWD='G:/Vivadoprojects/EX4_Frequency_divider/EX4_Frequency_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EX4_Frequency_divider_sourcecode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EX4_Frequency_divider_sourcecode.tcl
