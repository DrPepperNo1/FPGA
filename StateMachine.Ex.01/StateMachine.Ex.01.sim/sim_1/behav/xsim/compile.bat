...
REM
REM Generated by Vivado on Sun Jan 23 13:35:49 +0800 2022
...
echo "xvlog --incr --relax -prj simcounter0_11_vlog.prj"
call xvlog  --incr --relax -prj simcounter0_11_vlog.prj -log xvlog.log
