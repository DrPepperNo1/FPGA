...
REM
REM Generated by Vivado on Sat Feb 12 13:23:01 +0800 2022
...
echo "xvlog --incr --relax -prj tb_EX7_vlog.prj"
call xvlog  --incr --relax -prj tb_EX7_vlog.prj -log xvlog.log
