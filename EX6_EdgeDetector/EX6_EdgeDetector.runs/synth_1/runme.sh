...
HD_PWD='G:/Vivadoprojects/Tasks_2022-1_2022-2/EX6_EdgeDetector/EX6_EdgeDetector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EX6_EdgeDetector_SourceCode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EX6_EdgeDetector_SourceCode.tcl
