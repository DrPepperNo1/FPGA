...
REM
REM Generated by Vivado on Wed Feb 02 23:29:26 +0800 2022
...
echo "xvlog --incr --relax -prj tb_EX4_vlog.prj"
call xvlog  --incr --relax -prj tb_EX4_vlog.prj -log xvlog.log
