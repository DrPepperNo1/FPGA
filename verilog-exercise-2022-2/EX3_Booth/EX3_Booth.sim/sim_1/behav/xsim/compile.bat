...
REM
REM Generated by Vivado on Mon Feb 07 23:15:20 +0800 2022
...
echo "xvlog --incr --relax -prj tb_EX3_vlog.prj"
call xvlog  --incr --relax -prj tb_EX3_vlog.prj -log xvlog.log
