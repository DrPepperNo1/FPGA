...
REM
REM Generated by Vivado on Tue Mar 01 00:04:35 +0800 2022
...
echo "xvlog --incr --relax -prj tb_EX8_vlog.prj"
call xvlog  --incr --relax -prj tb_EX8_vlog.prj -log xvlog.log
