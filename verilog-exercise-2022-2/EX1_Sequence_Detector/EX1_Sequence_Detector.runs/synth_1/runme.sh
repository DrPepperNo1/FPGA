...
HD_PWD='G:/Vivadoprojects/EX1_Sequence_Detector/EX1_Sequence_Detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EX1_Sequence_Detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EX1_Sequence_Detector.tcl
