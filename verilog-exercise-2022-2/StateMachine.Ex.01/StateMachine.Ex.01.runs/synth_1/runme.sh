...
HD_PWD='G:/Vivadoprojects/StateMachine.Ex.01/StateMachine.Ex.01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter0_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter0_10.tcl
