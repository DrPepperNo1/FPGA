...
REM
REM Generated by Vivado on Fri Feb 04 11:17:05 +0800 2022
...
echo "xvlog --incr --relax -prj tb_EX1_vlog.prj"
call xvlog  --incr --relax -prj tb_EX1_vlog.prj -log xvlog.log
