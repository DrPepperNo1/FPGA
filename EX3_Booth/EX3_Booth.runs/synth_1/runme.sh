...
HD_PWD='G:/Vivadoprojects/EX3_Booth/EX3_Booth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EX3_Booth_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EX3_Booth_8bit.tcl
