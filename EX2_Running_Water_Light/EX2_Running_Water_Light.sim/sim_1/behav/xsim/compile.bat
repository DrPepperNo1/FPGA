...
REM
REM Generated by Vivado on Fri Feb 04 23:57:36 +0800 2022
...
echo "xvlog --incr --relax -prj tb_EX2_vlog.prj"
call xvlog  --incr --relax -prj tb_EX2_vlog.prj -log xvlog.log
