...
HD_PWD='G:/Vivadoprojects/Tasks_2022-1_2022-2/EX2_Running_Water_Light/EX2_Running_Water_Light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RunningWaterLight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RunningWaterLight.tcl -notrace
